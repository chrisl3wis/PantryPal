...
<form>
    <input class="ingred" type="text" name="ingredient1" placeholder = "Ingredient 1"> &nbsp; &nbsp; <input class="ingred"  type="text" name="ingredient2" placeholder = "Ingredient 2"> &nbsp; &nbsp; <input class="ingred"  type="text" name="ingredient3" placeholder = "Ingredient 3">
    <br><br>
