...
class FGMembersite
{
    ...
    function Login()
    {
		...
		if($throttle_delay > 0){
			...
			"Has been throttled for incorrect username/password <br/>Email address is ".$_POST['username']);
			return false;
		}
		...
		{ 
			...
			$this->createErrorLog("The error has been triggered from Login: fg_membersite.php : ".$e->getMessage());
    ...
    {
        return isset($_SESSION['name_of_user'])?$_SESSION['name_of_user']:'my account';
    }
    ...
    function ChangePassword($oldPassword, $newPassword)
    {
		...
		{ 
			...
			$this->createErrorLog("The error has been triggered from ChangePassword fg_membersite.php : ".$e->getMessage());
    ...
    function CollectRegistrationSubmission(&$formvars)
    {
        ...
        $formvars['username'] = $this->clean($_POST['username']);
    ...
    function SaveToDatabase(&$formvars)
    {
		...
		{ 
			...
			$this->createErrorLog("The error has been triggered from SaveToDatabase fg_membersite.php : ".$e->getMessage());
